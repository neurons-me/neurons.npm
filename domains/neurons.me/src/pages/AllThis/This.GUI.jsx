  ...
  return (
    <Box sx={{ padding: 4, textAlign: 'center' }}>
      ...
      <Typography variant="subtitle1" gutterBottom>
        A lightweight and modular system to generate dynamic user interfaces for interaction and visualization of standardized data models.
      </Typography>

      <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, marginTop: 3 }}>
        <a href="https://github.com/neurons-me/this.gui" target="_blank" rel="noopener noreferrer" style={{
          display: 'inline-block',
          padding: '10px 16px',
          border: `1px solid ${theme.palette.divider}`,
          borderRadius: '6px',
        ...
        <a href="https://www.npmjs.com/package/this.gui" target="_blank" rel="noopener noreferrer" style={{
          display: 'inline-block',
          padding: '10px 16px',
          border: `1px solid ${theme.palette.divider}`,
          borderRadius: '6px',
      ...
      <Box sx={{ textAlign: 'left', display: 'inline-block', marginTop: '24px' }}>
        ...
        <Box sx={commandBoxStyle}>import GUI from 'this.gui'</Box>
      </Box>
