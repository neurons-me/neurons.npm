...
import { FiBarChart2, FiMail, FiUpload, FiCpu, FiZap, FiDollarSign, FiDatabase, FiLayers, FiSettings, FiCalendar } from 'react-icons/fi';
...
const EmbracingML = () => {
  return (
    <Box sx={{ pt: 2, px: 4, textAlign: 'center' }}>
      ...
      <TextQuote>AI isn’t the future — it’s the present. Let’s make it work.</TextQuote>
  <Typography variant="body1" sx={{ marginTop: '1rem' }}>
      ...
      <Box sx={{ display: 'flex', gap: 3, justifyContent: 'center', mt: 3, mb: 3 }}>
        <Box sx={{ width: '50%', textAlign: 'left' }}>
          ...
          >
            Start your AI Integration:&nbsp;<FiCalendar style={{ marginRight: 6 }} />Book Appointment
          </RouterLink>
        </Box>
        ...
        <Box sx={{ width: '50%', textAlign: 'right' }}>
          <Gridme columns={3} columnGap=".5rem" rowGap=".5rem" sx={{ my: 0 }}>
            {[
              { label: 'Data-Driven Businesses', icon: <FiBarChart2 style={{ color: '#7aa5ff' }} />, href: '/business/data' },
              { label: 'Smart Emails', icon: <FiMail style={{ color: '#34c759' }} />, href: '/contact' },
              { label: 'Plug Your Data In', icon: <FiUpload style={{ color: '#00ffd9' }} />, href: '/business/data' },
              { label: 'Embracing ML', icon: <FiCpu style={{ color: '#ff4dd2' }} />, href: '/business/system-development' },
              { label: 'Automations', icon: <FiZap style={{ color: '#ffd166' }} />, href: '/business/system-development' },
              { label: 'Cost Reductions', icon: <FiDollarSign style={{ color: '#ff7f00' }} />, href: '/business/system-development' },
              { label: 'Data & Analytics', icon: <FiDatabase style={{ color: '#8afff2' }} />, href: '/business/data' },
              { label: 'Operations at Scale', icon: <FiLayers style={{ color: '#b084ff' }} />, href: '/business/system-development' },
              { label: 'System Development', icon: <FiSettings style={{ color: '#ffffff' }} />, href: '/business/system-development' },
            ].map((item, index) => (
