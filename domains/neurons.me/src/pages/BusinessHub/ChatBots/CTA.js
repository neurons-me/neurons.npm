...
const CTABotsOptions = {
  ...
  items: [
    ...
    },
    {
      ...
      to: 'https://wa.me/527291671525?text=Hi!%20I%20would%20like%20to%20know%20more%20about%20ChatBots',
      variant: 'neutral',
  ...
  positioning: {
    ...
    reserveSpace: true     // asegura que deje espacio debajo del navbar
  },
...
export default CTABotsOptions;
export { CTABotsOptions };