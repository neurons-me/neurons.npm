...
const ThisDictionaries = () => {
  ...
  return (
    <Box sx={{ padding: 4, textAlign: 'center' }}>
      ...
      <Box
        component="img"
        src="/media/all-this/this.dictionaries.png"
        alt="this.dictionaries"
      ...
      <Typography variant="subtitle1" gutterBottom>
        This module helps organize and access various dictionaries of standardized tokens, tags, or metadata for use across different systems and models.
      </Typography>

      <Box sx={{ display: 'flex', justifyContent: 'center', gap: 2, marginTop: 2 }}>
        <a
          href="https://github.com/neurons-me/this.dictionaries"
          target="_blank"
        ...
        <a
          href="https://www.npmjs.com/package/this.dictionaries"
          target="_blank"
          rel="noopener noreferrer"
          style={buttonStyle}
        >
      ...
      <Box sx={{ textAlign: 'left', display: 'inline-block', marginTop: '24px' }}>
        ...
        <Box sx={commandBoxStyle}>npm i this.dictionaries</Box>

        <Typography variant="body2" sx={{ fontWeight: 600, marginTop: '16px', marginBottom: '4px' }}>
          Import this.dictionaries in your project:
        </Typography>
        <Box sx={commandBoxStyle}>import Dictionaries from 'this.dictionaries'</Box>
      </Box>
      ...
      <Typography sx={{ fontSize: '0.9rem', color: '#777', marginTop:'21px'}}>
            ...
            License: MIT — <a href="https://www.npmjs.com/package/this.dictionaries">this.dictionaries</a>
          </Typography>
...
export default ThisDictionaries;